...
<style>
  ...
  .card { background:#1a1a1a; border:1px solid #2a2a2a; border-radius:12px; padding:40px; min-width:320px; }
  h1 { text-align:center; font-size:1.5rem; margin-bottom:28px; color:#ffffff; letter-spacing:0.04em; }
